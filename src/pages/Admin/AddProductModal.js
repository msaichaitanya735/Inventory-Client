...
const AddProductModal = ({ isOpen, onRequestClose, onAddProduct }) => {
  ...
  const handleAddProduct = () => {
    ...
    // Validate and send product data to the parent component
      ...
      const apiUrl = ` https://main.dwoh96qwfxa1j.amplifyapp.com/inventory/addproduct?name= ${productName}&description= ${productDescription}&categoryId=${productCategory}&imgURL= ${productImageURL}&returnable=${returnable}`;
      console.log(apiUrl);
