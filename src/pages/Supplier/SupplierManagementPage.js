...
const SupplierManagementPage = () => {
  ...
  const fetchSupplierProducts = async (userId) => {
    try {
      const response = await axios.get(`http://44.203.214.233:8080/inventory/getsupplier?supplierId=${userId}`);
  ...
  const fetchAllProducts = async (userId) => {
    try {
      const response = await axios.get(`http://44.203.214.233:8080/order/getproductsnotinsupplier?supplierId=${userId}`);
  ...
  const handleAddProduct = async (productId) => {
    ...
    try {
      ...
      await axios.post(`http://44.203.214.233:8080/order/addsupplierproduct?supplierId=${userId}&productId=${productId}`);
  ...
  const handleDeleteAllProducts = async () => {
    try {
      await axios.delete('http://44.203.214.233:8080/inventory/deleteproductsfromsupplier', {
